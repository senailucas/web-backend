...
class Movies(Resource):
    def get(self):
        return [movie.json() for movie in MovieModel.query.all()]
...
class Movie(Resource):
    ...
    minha_requisicao.add_argument('rating', type=float, required=True, help="name is required")
    minha_requisicao.add_argument('duration', type=int, required=True, help="duration is required")
    minha_requisicao.add_argument('lancamento', type=str, required=True, help="lancamento is required")
    minha_requisicao.add_argument('faixa_etaria', type=str, required=True, help="faixa etaria is required")
    minha_requisicao.add_argument('trailer', type=str, required=True, help="trailer is required")
